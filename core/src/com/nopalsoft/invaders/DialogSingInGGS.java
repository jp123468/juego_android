...
public class DialogSingInGGS {
    ...
    public void showDialogSignIn() {
        dialogSignIn = new Dialog(Assets.idiomas.get("information"), Assets.styleDialogPause);
        Label lblContenido = new Label(Assets.idiomas.get("Ready_to_have_fun_and_be_the_best"), Assets.styleLabelDialog);
        ...
        TextButton btSignIn = new TextButton(Assets.idiomas.get("continue"), Assets.styleTextButton);
